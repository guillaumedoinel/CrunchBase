(function() {
  ...
  myConnector.getData = function(table, doneCallback) {
    ...
    if (table.tableInfo.id == "Transactions") {
      ...
      //var CompaniesList = ["Audi","BMW", "Fiat","Chrysler","Ford","General Motors","Honda","Hyundai","Jaguar","Land Rover","KIA","Lexus","Mazda","Daimler","Mitsubishi","Nissan","Porsche","PSA","Peugeot","Citroen","Renault","Seat","Skoda","Tesla","Toyota","Volvo","VW" ];
      var CompaniesList = ["Peugeot","Citroen","Renault","Seat","Skoda","Tesla"];
